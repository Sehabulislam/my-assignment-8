    ...
    return (
        <div className='p-2'>
            ...
            <div className='flex flex-col md:flex-row justify-center md:justify-start items-center gap-8 border-b-2 border-gray-300 py-5'>
                <div>
                    <img src={image} alt="" className='w-40 md:w-60 rounded-2xl'/>
                </div>
                 <div className='space-y-3'>
                    ...
                    <div>
                        <button className='btn bg-[#00D390] text-white hover:shadow-2xl hover:scale-103'>Install Now <span>({size})</span></button>
                    </div>
                    </div>
                </div>
                <div className='flex justify-center items-center my-10 border-b-2 border-gray-300'>
                    <div className='mb-5'>
