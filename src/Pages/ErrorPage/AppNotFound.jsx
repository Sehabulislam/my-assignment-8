...
const AppNotFound = () => {
    ...
    return (
        <div className='min-h-[calc(100vh-300px)] flex flex-col justify-center items-center space-y-6 py-5'>
            <img src="/src/assets/App-Error.png" alt="" className='w-100'/>
            ...
            <button onClick={()=> navigate(-1)} className='btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white hover:shadow-2xl hover:scale-102'>Go Back!</button>
        </div>
    );
};
